<%-- 
    Document   : footer
    Created on : ene 7, 2019, 11:38:38 p.m.
...
<html>
    ...
    <center>
        <footer>
            <div class="footer-area" style="margin-top: auto;">
                <p>© Copyright 2019 - Edad de Oro</p>
            </div>
        </footer>
    </center>
    ...
    <!-- DataTables Scripts -->
    <script src="recursos/js/datatables.js" type="text/javascript"></script>
